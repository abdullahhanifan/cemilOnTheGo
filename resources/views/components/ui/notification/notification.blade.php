...
<div
    ...
    x-init="if (type === 'success') { setTimeout(() => isVisible = false, 5000) }"
    x-show="isVisible"
    x-cloak
    class="flex items-center justify-between gap-3 w-full sm:max-w-[340px] rounded-md border-b-4 bg-white p-3 shadow-theme-sm dark:bg-gray-dark"
